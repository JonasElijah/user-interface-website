...
if(mysqli_num_rows($result) == 0)
{
	...
	echo '<h1 align = "center" style = "color: #fdf4eb font-size: 35px;text-shadow: -1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000, 1px 1px 0 #000;">Error, cart not found. Please log in or add to your cart.</h1>';
}
else
{
